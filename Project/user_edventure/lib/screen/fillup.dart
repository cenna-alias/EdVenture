...
class _FILLState extends State<FILL> {
  ...
  Future<void> _playBackgroundMusic() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Error playing music: $e')));
    }
  }
  ...
  Future<void> speak(String text) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Error with TTS: $e')));
    }
  }

  Future<void> fetchFILL() async {
    try {
      final questionResponse = await supabase
          ...
          .eq('qstn_level', currentQuestionLevel);
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: hasPassingScore ? Colors.green : Colors.red,
                  ),
                ),
                const SizedBox(height: 8),
            ...
            actions: [
              if (hasPassingScore && currentQuestionLevel < 5)
                TextButton(
                  onPressed: () {
                          ...
                          Flexible(
                            child: RichText(
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: currentQuestion['qstn_text1'] ?? '',
                                    style: const TextStyle(
                                      fontSize: 22,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black87,
